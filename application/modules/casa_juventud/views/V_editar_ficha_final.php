...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group" id="inscripcion-container">
                                    ...
                                    <input type="text" id="fechainscrip" class="form-control" readonly placeholder="Selecciona la fecha">
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="codigoID">Código de ficha:</label>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <select readonly class="form-control" id="selectTipoDoc">
                    ...
                    <div class="col-4">
                        <div class="form-group doc">
                            ...
                            <input readonly class="form-control" id="documentoID" name="documento"
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            <label for="selectTipoDoc">Documento</label>
                            <select readonly class="form-control" id="selectTipoDocApoderado">
                                <option value="">Seleccione un tipo de documento</option>
                                <?php echo $combo_tipodoc?>
                            </select>
                        </div>
                    ...
                    <div class="col-3">
                            <div class="form-group">
                                ...
                                <button id="btnBuscarA" onclick="buscarApoderado()" type="button"
    ...
    <script src="<?php echo base_url(); ?>public/casa_juventud/js/edit_ficha_casa_juventud.js"></script>
