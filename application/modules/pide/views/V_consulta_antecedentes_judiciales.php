...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container" style="padding: 20px 0 20px 0">
                <h4 style="margin-bottom: 20px">Consulta Antecedentes Judiciales</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="nombre" aria-describedby="searching" placeholder="Nombres">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="paterno" aria-describedby="searching" placeholder="Apellido Paterno">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="materno" aria-describedby="searching" placeholder="Apellido Materno">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <button id="btnBuscar" onclick="BuscarPersona()" type="button" class="btn btn-primary form-control" style="width: inherit; display: block; background-color:#79AAFF !important;">Buscar</button>
    ...
    <script src="<?php echo base_url();?>public/pide/js/consulta_antecedentes_judiciales.js"></script>
