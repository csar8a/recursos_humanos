...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container" style="padding: 20px 0 20px 0">
                <h4 style="margin-bottom: 20px">Consulta Antecedentes Penales</h4>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="dni" placeholder="DNI">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    <label for="dni">2<sup>do</sup> nombre:</label>
                                    <input class="form-control" id="segname"
                                        placeholder="Nombre">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    <label for="dni">3<sup>er</sup> nombre:</label>
                                    <input class="form-control" id="tername"
                                        placeholder="Nombre">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="ap"
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="am" 
                                        placeholder="Apellido materno">
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="form-group">
                                <label for="descripcionID">Motivo consulta</label>
                                <textarea class="form-control" id="motivo" rows="2" aria-describedby="searching"></textarea>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <button id="btnBuscar" onclick="BuscarAntecedentesPenales()" type="button"
    ...
    <script src="<?php echo base_url(); ?>public/pide/js/consulta_antecedentes_penales.js"></script>
