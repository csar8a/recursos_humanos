...
<div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container" style="padding: 20px 0 20px 0">
                <h4 style="margin-bottom: 20px">Consulta de Grados:</h4>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="selectTipoDoc">
                                        ...
                                        <option value="4">Cédula Diplomática de identidad</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-4">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <button id="btnBuscar" onclick="buscarGrados()" type="button" class="btn btn-primary form-control" style="width: inherit; display: block; background-color:#79AAFF !important;">Buscar</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php echo base_url();?>public/pide/js/consulta_sunedu_grados.js"></script>
