...
<head>
    ...
    <title>Consultas Policiales</title>
...
<div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container" style="padding: 20px 0 20px 0">
                <h4 style="margin-bottom: 20px">Consulta Policial:</h4>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="dni" aria-describedby="searching" placeholder="DNI">
    ...
    <script src="<?php echo base_url();?>public/pide/js/consulta_policial.js"></script>
