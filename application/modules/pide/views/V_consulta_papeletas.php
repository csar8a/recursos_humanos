...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container" style="padding: 20px 0 20px 0">
                <h4 style="margin-bottom: 20px">Consulta Papeletas</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <button id="btnBuscar" onclick="buscarPapeletas()" type="button" class="btn btn-primary form-control" style="width: inherit; display: block; background-color:#79AAFF !important;">Buscar</button> 
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php echo base_url();?>public/pide/js/consulta_papeletas.js"></script>
