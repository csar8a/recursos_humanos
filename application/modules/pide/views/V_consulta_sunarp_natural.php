...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container" style="padding: 20px 0 20px 0">
                <h4 style="margin-bottom: 20px">Consulta SUNARP-Persona Natural</h4>
        ...
        <div class="modal-dialog modal-full" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Consulta de Asientos por predio - Natural</h5>
    ...
    <script src="<?php echo base_url(); ?>public/pide/js/consulta_sunarp_natural.js"></script>
