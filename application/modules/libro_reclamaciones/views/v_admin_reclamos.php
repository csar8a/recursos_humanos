...
<head>
    ...
    <title>Admin Libro de Reclamaciones</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>public/reclamos/css/admin_reclamos.css">
...
<body>
                ...
                <div class="card">
                    <div class="card-body">
                        <table id="example" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody id="tb_reclamos">
                                <?php echo $tb_reclamos?>
                            </tbody>    
                        </table>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-3 col-form-label">RECLAMO:</label>
                            <div class="col-sm-9">
    ...
    <script src="<?php echo base_url(); ?>public/reclamos/js/admin_reclamos.js"></script>
