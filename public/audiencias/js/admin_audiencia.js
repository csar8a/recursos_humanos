...
function modalVer(e){
    ...
    htmlMovs = "";
    $.ajax({
        url: 'audiencias/C_admin_audiencia/getMensaje',
        data: {
            idcontacto 
        },
        type: 'POST'
...
function asignarArea(){
    ...
    $.ajax({
        url: 'audiencias/C_admin_audiencia/asignarArea',
        data: {
...
function archivarContacto(){
    ...
    var objparent = $(obj).parent().parent();
    $.ajax({
        url: 'audiencias/C_admin_audiencia/archivarContacto',
        data: {
            idcontacto: idcontacto
        },
        type: 'POST'
...
function responderVecino(){
    ...
    $.ajax({
        url: 'audiencias/C_admin_audiencia/responderVecino',
        data: {
            idcontacto: idcontacto,
            mensaje: mensaje
        },
